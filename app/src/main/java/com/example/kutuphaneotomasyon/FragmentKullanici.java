...
public class FragmentKullanici extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_kullanici,container,false);
        ...
        fragmentListesi.add(new FragmentKullaniciGoruntule());
        fragmentListesi.add(new FragmentKullaniciEkle());
        fragmentListesi.add(new FragmentKaraListe());
