...
public class KategoriKitaplariActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kategori_kitaplari);
    ...
    public void kategoriKitaplariCek(int kategori_id){
        ...
        StringRequest istek = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    adapter = new KitaplarAdapter(KategoriKitaplariActivity.this,vtDenGelenKitaplar);
        ...
        Volley.newRequestQueue(KategoriKitaplariActivity.this).add(istek);
    }
