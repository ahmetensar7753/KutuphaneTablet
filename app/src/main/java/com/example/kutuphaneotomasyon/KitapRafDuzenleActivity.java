...
public class KitapRafDuzenleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kitap_raf_duzenle);
    ...
    public void kitapCek(int id){
        ...
        Volley.newRequestQueue(KitapRafDuzenleActivity.this).add(istek);
    }
        ...
        StringRequest istek = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    veriAdapter = new ArrayAdapter<String>(KitapRafDuzenleActivity.this, android.R.layout.simple_list_item_1,android.R.id.text1,kategoriAdListesi);
    ...
    public void kitapGuncelle(int id,String kitapAd,String resimAd,String bolge,String raf,int kategori_id,String yazar_ad){
        ...
        StringRequest istek = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(KitapRafDuzenleActivity.this,"Kitap Güncellendi.",Toast.LENGTH_SHORT).show();
                onBackPressed();
            }
        }, new Response.ErrorListener() {
            @Override
