...
import com.example.kutuphaneotomasyon.adapters.AlinanKitaplarAdapter;
import com.example.kutuphaneotomasyon.adapters.KullaniciKitapGecmisiAdapter;
...
public class KullaniciActivity2 extends AppCompatActivity {

    private Integer kullaniciID;
    private KullaniciKitapGecmisiAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kullanici2);
    ...
    public void kitapGecmisCek(int id){
        ...
        StringRequest istek = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    adapter = new KullaniciKitapGecmisiAdapter(KullaniciActivity2.this,vtDenCekilenAlinanlar);
        ...
        Volley.newRequestQueue(KullaniciActivity2.this).add(istek);
    }
