...
public class PersonelDuzenleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personel_duzenle);
    ...
    public void perGuncelle(int id,String ad,String soyad,String tel,String gorev){
        ...
        StringRequest istek = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(PersonelDuzenleActivity.this,"Bilgiler Güncellendi.",Toast.LENGTH_SHORT).show();
            }
        ...
        Volley.newRequestQueue(PersonelDuzenleActivity.this).add(istek);
    }
