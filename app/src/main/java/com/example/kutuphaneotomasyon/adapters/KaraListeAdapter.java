...
public class KaraListeAdapter extends RecyclerView.Adapter<KaraListeAdapter.CardNesneTutucuKaraListe>{

    private Context mContext;
    private ArrayList<KaraListe> disaridanGelenKaraListe = new ArrayList<>();

    public KaraListeAdapter(Context mContext, ArrayList<KaraListe> disaridanGelenKaraListe) {
    ...
    public CardNesneTutucuKaraListe onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_tasarim_kara_liste,parent,false);
