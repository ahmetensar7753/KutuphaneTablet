...
import com.example.kutuphaneotomasyon.KategoriKitaplariActivity;
import com.example.kutuphaneotomasyon.R;
import com.example.kutuphaneotomasyon.siniflar.Kategoriler;

import java.util.ArrayList;

public class KategoriAdapter extends RecyclerView.Adapter<KategoriAdapter.CardNesneTutucuKategori>{

    private Context mContext;
    private ArrayList<Kategoriler> disaridanGelenKategoriler = new ArrayList<>();

    public KategoriAdapter(Context mContext, ArrayList<Kategoriler> disaridanGelenKategoriler) {
    ...
    public CardNesneTutucuKategori onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_tasarim_kategori_ara,parent,false);
    ...
    public void onBindViewHolder(@NonNull CardNesneTutucuKategori holder, int position) {
        ...
        holder.cardViewKategori.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, KategoriKitaplariActivity.class);
