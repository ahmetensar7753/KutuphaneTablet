...
import com.example.kutuphaneotomasyon.KitapRafDuzenleActivity;
import com.example.kutuphaneotomasyon.R;
import com.example.kutuphaneotomasyon.siniflar.Kitaplar;

import java.util.ArrayList;

public class KitapDuzenleAdapter extends RecyclerView.Adapter<KitapDuzenleAdapter.CardNesneTutucuKitapDuzenle>{

    private Context mContext;
    private ArrayList<Kitaplar> disaridanGelenKitaplar = new ArrayList<>();
    private ArrayList<Kitaplar> fullList;

    public KitapDuzenleAdapter(Context mContext, ArrayList<Kitaplar> disaridanGelenKitaplar) {
    ...
    public CardNesneTutucuKitapDuzenle onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_tasarim_kitap_raf_duzenle,parent,false);
    ...
    public void onBindViewHolder(@NonNull CardNesneTutucuKitapDuzenle holder, int position) {
        ...
        holder.cardViewKitapRafDuzenle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, KitapRafDuzenleActivity.class);
