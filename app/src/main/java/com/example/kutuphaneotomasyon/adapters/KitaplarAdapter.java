...
import com.example.kutuphaneotomasyon.KitapDetayActivity;
...
public class KitaplarAdapter extends RecyclerView.Adapter<KitaplarAdapter.CardNesneTutucuKitaplar>{

    private Context mContext;
    private ArrayList<Kitaplar> disaridanGelenKitaplar = new ArrayList<>();
    private ArrayList<Kitaplar> fullList;

    public KitaplarAdapter(Context mContext, ArrayList<Kitaplar> disaridanGelenKitaplar) {
    ...
    public CardNesneTutucuKitaplar onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_tasarim_kitap,parent,false);
