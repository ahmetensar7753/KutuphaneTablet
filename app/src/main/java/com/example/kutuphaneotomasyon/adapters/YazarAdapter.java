...
import com.example.kutuphaneotomasyon.YazarKitaplariActivity;
import com.example.kutuphaneotomasyon.siniflar.Kitaplar;
import com.example.kutuphaneotomasyon.siniflar.Yazarlar;

import java.util.ArrayList;

public class YazarAdapter extends RecyclerView.Adapter<YazarAdapter.CardNesneTutucuYazar>{

    private Context mContext;
    private ArrayList<Yazarlar> disaridanGelenYazarlar = new ArrayList<>();
    private ArrayList<Yazarlar> fullList;

    public YazarAdapter(Context mContext, ArrayList<Yazarlar> disaridanGelenYazarlar) {
    ...
    public CardNesneTutucuYazar onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_tasarim_yazar_ara,parent,false);
    ...
    public void onBindViewHolder(@NonNull CardNesneTutucuYazar holder, int position) {
        ...
        holder.cardViewYazar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, YazarKitaplariActivity.class);
